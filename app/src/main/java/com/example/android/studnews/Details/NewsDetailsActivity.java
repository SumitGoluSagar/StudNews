...
import com.example.android.studnews.Visual.ZoomOutPageTransformer;
...
public class NewsDetailsActivity extends FragmentActivity
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return NewsDetailsFragment.newInstance(news.getImageUrl(), news.getHeading(), news.getNewsText());
        }
