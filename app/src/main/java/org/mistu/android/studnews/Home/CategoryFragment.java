...
import org.mistu.android.studnews.Utils.DataUtils;
...
public class CategoryFragment extends DialogFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        iconList = getResources().obtainTypedArray(R.array.icons);
        categoryList = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.categories)));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new CategoryFragmentAdapter(categoryList, mListener, iconList);
